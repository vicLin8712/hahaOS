...
static const struct err_code desc[] = {
    ...
    {ERR_KCB_ALLOC,"KCB malloc fail"},         /* Kernel control block allocation fail */
    {ERR_TCB_ALLOC,"TCB malloc fail"},         /* Thread control block allocation fail */
    {ERR_STACK_ALLOC,"Task stack malloc fail"},       /* Task stack allocation fail */
